...
public class AddressController {
    ...
    public ResponseEntity<AddressData> getAddress(@PathVariable("id") @NotNull Integer id) {
        if (id <= 0) {
    ...
    public void deleteAddress(@PathVariable("id") @NotNull Integer id) {
        if (id <= 0) {
            throw new RequestNotValidException("Id must not be negative or Zero");
        }
